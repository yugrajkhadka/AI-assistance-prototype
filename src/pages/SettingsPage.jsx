...
import { Settings, Monitor, Palette, Shield, Bell, Download, Accessibility, Eye } from 'lucide-react'
  ...
  return (
    <div className="max-w-3xl mx-auto animate-fadeIn">
      ...
      <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`w-10 h-5 rounded-full transition ${highContrast ? 'bg-cinema-500' : 'bg-slate-700'}`}
              >
        ...
        <div className="p-4 rounded-xl border border-slate-800 bg-slate-900/40">
          <div className="flex items-center gap-2 mb-4">
            <Accessibility className="w-4 h-4 text-cinema-400" />
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`w-10 h-5 rounded-full transition ${haptics ? 'bg-cinema-500' : 'bg-slate-700'}`}
              >
                <div className={`w-4 h-4 rounded-full bg-white transition transform ${haptics ? 'translate-x-5' : 'translate-x-0.5'}`} />
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 rounded-xl border border-slate-800 bg-slate-900/40">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm text-slate-300">Data Anonymization</span>
              <button className="px-3 py-1.5 bg-slate-800 text-slate-400 rounded-md text-xs hover:text-white transition">Configure</button>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 rounded-xl border border-slate-800 bg-slate-900/40">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`w-10 h-5 rounded-full transition ${notifications ? 'bg-cinema-500' : 'bg-slate-700'}`}
            >
